@extends('layouts.app', ['title' => 'Daftar Menu - Admin'])
...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="-mx-3 sm:-mx-8 px-3 sm:px-8 py-3 overflow-x-auto">
                ...
                <table class="min-w-full table-auto">
                    ...
                    <tbody class="bg-gray-200">
                        ...
                        <tr class="border bg-white">
                            <td class="px-12 py-2 flex justify-center">
                                <img src="{{ $mn->image }}" class="w-20 h-20 object-cover rounded">
                            </td>
                            <td class="px-10 py-2">
                                {{ $mn->nama_menu}}
                            </td>
                            <td class="px-16 py-2">
                                {{ strip_tags($mn->deskripsi)}}
                            </td>
                            <td class="px-16 py-2">
                                {{$mn->harga}}
                            </td>
                            <td class="px-10 py-2 text-center">
                                <a href="{{ route('admin.menu.edit', $mn->id) }}"
                                    class="bg-indigo-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">EDIT</a>
                                <button onClick="destroy(this.id)" id="{{ $mn->id }}"
